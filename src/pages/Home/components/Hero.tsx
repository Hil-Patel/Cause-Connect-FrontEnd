            ...
            <div className="relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl">
                ...
                <div
                    ...
                    <div className="flex flex-col p-12 md:px-16">
                        ...
                        <div className="mt-8">
                            <a href="#"
                                className="inline-block w-full text-center text-lg font-medium text-gray-100 bg-blue-600 border-solid border-2 border-gray-600 py-4 px-10 hover:bg-blue-800 hover:shadow-md md:w-48">Get Involved
                            </a>
                        </div>
                    </div>
                </div>
